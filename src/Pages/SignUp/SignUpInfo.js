...
class SignUpInfo extends Component {
  ...
  validationfilter = (type, value) => {
    const filter = {
      ...
      email: /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i.test(
        value
      )
        ? true
        : false,
        ...
        <form>
          <div>
            <div>
              ...
              />
              <img
                className={nick_name.state ? 'imgShow' : ''}
                src="images/lock.png"
                alt="id통과이미지"
              />
            ...
            <div>
              ...
              />
              <img
                className={password.state ? 'imgShow' : ''}
                src="images/lock.png"
                alt="비밀번호 패스 이미지"
              />
              <div className="errorMsg">
            ...
            <div>
              ...
              />
              <img
                className={passwordCheck.state ? 'imgShow' : ''}
                src="images/lock.png"
                alt="비밀번호 확인 패스 이미지"
              />
              <div className="errorMsg">
            ...
            <div>
              ...
              />
              <div className="errorMsg">
                {email.value ? (email.state ? '' : '이메일 주소를 다시 확인해주세요') : ''}
              </div>
            </div>
            <div>
              <label>이름</label>
          ...
          <input
            className="SignUpInfoBtn"
            type="button"
            name="signup"
            value="다음"
            onClick={this.SignUpSendInfo}
          />
        </form>
      </div>
    );
